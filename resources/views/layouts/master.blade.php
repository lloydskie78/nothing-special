...
<head xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!--<meta name="title" content="CITIHARDWARE - The Home Improvement Warehouse">-->
    ...
    <!--    OWL CAROUSEL-->
    <link rel="stylesheet" href="{{asset('assets/css/iziModal.min.css')}}" type="text/css">
    <!--iziModal-->
    <link rel="stylesheet" href="{{asset('assets/css/jquery.fancybox.css')}}" type="text/css">
    <!--fancybox plugin-->
    <link rel="stylesheet" href="{{asset('assets/css/jquery-ui.min.css')}}" type="text/css">
    <!--Jquery UI-->
    <link rel="stylesheet" href="{{asset('assets/css/hover.min.css')}}" type="text/css">
    <!--hover plugin-->
    <link rel="stylesheet" href="{{asset('assets/css/css-loader.min.css')}}">
    <!--Overlay Loader-->
    <link rel="stylesheet" href="{{asset('assets/css/balloon.min.css')}}">
    <!--Balloon Plugin-->
    ...
    <link rel="stylesheet" href="{{asset('assets/css/custom.small-screen.min.css')}}"
...
<body>
    ...
    <div id="contain" style="margin-top: 4.6rem;">
        <header>
  ...
  (function() {
    ...
    <!--OWL CAROUSEL-->
    <script src="{{asset('assets/js/iziModal.min.js')}}" type="text/javascript"></script>
    <!--iziModal-->
    ...
    <!--Mapresizer plugin-->
    @stack('scripts')
    <script src="{{asset('assets/js/scripts.js')}}?v=26ab" type="text/javascript"></script>
</body>
