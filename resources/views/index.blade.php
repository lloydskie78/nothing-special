...
@section('header-content')
    ...
    <div class="image-container" id="bgimgcontainer">
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                {{-- <div class="numbertext">3 / 3</div> --}}
                <img src="{{ asset('assets/img/banner/01_seasons greetings.webp') }}" style="width:100%; height: auto;"
                    onerror="if (this.src != '{{ asset('assets/img/banner/01_seasons greetings.jpg') }}') this.src = '{{ asset('assets/img/banner/01_seasons greetings.jpg') }}';"
