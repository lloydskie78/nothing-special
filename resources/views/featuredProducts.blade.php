...
@section('bg-img', asset('assets/img/banner/Featured Product.jpg'))
@section('product-cat')
    <h2 class="b-b p-b">Categories <span><a href="javascript:void(0)" class="closebtn"
                onclick="closeNav()">&times;</a></span></h2>
@endsection
    ...
    <aside class="prodlist" id="listShow">
        @foreach ($products_featured as $product)
            ...
            <a class='feaProduct_box hvr-grow productClass indiProducts' data-fancybox
                ...
                <div class='featuredPrdctimagecontainer'><img
                        src='{{ asset("assets/img/products/featuredImage/$product->feaImageFile") }}'
                        alt="{{ $product->details }}"
