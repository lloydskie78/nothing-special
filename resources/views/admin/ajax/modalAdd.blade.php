@switch($form_id)
    ...
    <div class="container-fluid col-12">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                {{ Form::label('Division') }}
                {{ Form::select('idParent', ['' => 'Please Select'] + $select_divisions, null, ['class' => 'custom-select custom-select-sm', 'required']) }}
            </div>
            <div class="form-group col-md-3">
                {{ Form::label('Department') }}
                {{ Form::select('idSub', ['' => 'Please Select'] + $select_departments, null, ['class' => 'custom-select custom-select-sm', 'required']) }}
            </div>
            <div class="form-group col-md-3">
                {{ Form::label('Sub Department') }}
                {{ Form::select('idDepartmentSub', ['' => 'Please Select'] + $select_subDepartments, null, ['class' => 'custom-select custom-select-sm', 'required']) }}
            </div>
        </div>
        <div class="form-group">
            {{ Form::label('Details') }}
