...
@section('content')
    <div class="container-fluid">
        ...
        <div class="mb-2">
            <button data-btn='division_add' type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                data-modal="add" data-target="#myModal">Add Division</button>
            <button type="button" class="btn btn-primary btn-sm btn_edit" data-btn="division_edit" data-modal="edit">Edit
                Division/'s</button>
